...
export default function TireUserReviews() {
  const reviews = [
    {
      id: 1,
      author: 'Александр В.',
      ...
      pros: 'Абсолютно предсказуемое поведение на любых скоростях. Держак в поворотах феноменальный, даже на влажном асфальте. Износостойкость для UHP сегмента отличная.',
      cons: 'Цена кусается. Немного шумновата на шершавом асфальте.',
      text: 'Взял на замену заводскому ранфлэту. Разница колоссальная! Машина стала мягче, рулится острее, колейность почти не чувствуется. Лучшая резина, на которой я ездил.',
      likes: 14,
      dislikes: 1
    },
    {
